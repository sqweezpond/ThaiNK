            ...
            <!-- ส่วนรูป จบ -->
                  ...
                  <!-- text to Modal -->
                      <div class="login-display mt-lg-4">
                          <div class="col-xl-6 col-lg-4 col-md-4 col-5 px-0">
                    ...
                    <!-- text to Modal -->
                    <div class="col-xl-6 col-lg-8 col-md-8 col-7 px-0">
                      <p class="text-md-right text-sm-left  text-center">หากยังไม่ได้เป็นสมาชิค <a href="#"><span class="login-color-org " data-toggle="modal" data-target="#exampleModal1">ลงทะเบียน</span></a></p>
                    </div>
                  </div>
                <!-- Modal Register-->
