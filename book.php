                      ...
                      <div class="row mt-5">
                            ...
                            <thead>
                             <tbody>
                                <tr>
                                  ...
                                  <td class="text-center book-414-font">
                                    <p>200 บาท</p>
                        ...
                        <div class="col-lg-4  ">
                          ...
                          <div class="row book-shado my-4 m-0" >
                            <div class="col-lg-12">
                              <p class="home-font14">สรุปรายการสั่งซื้อ</p>
                            </div>
                            <div class="col-lg-12">
                              <p class="ml-1 mt-3 font-all-ting">180/2 ม.3 ซ.โยกย้าย ซอย 6 ถนน.บางกรวย-ไทรน้อย ต.บางใหญ่ อ.เมือง จ.นนทบุรี 11000</p>
                            </div>
                            <div class="col-lg-9 col-md-6 col-6 mt-3 font-all-ting" style="line-height: 10px;">
                              <p>จำนวน</p>
                              <p>ยอดรวม</p>
                              <p>ค่าจัดส่ง</p>
                              <p>ส่วนลด</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-6 text-right mt-3 font-all-ting" style="line-height: 10px;">
                              ...
                              <div class="col-lg-5  col-md-5 col-6 text-right">
                                <h5 class="book-color">360 บาท</h5>
                              </div>
                              <div class="col-lg-12 text-right ">
                                <p class="font-12">รวมภาษีมูลค่าเพิ่ม</p>
                              </div>
