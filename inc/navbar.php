										...
										<div class="col-md-5 col-12 text-right nav-p-r2 pr-0">
													...
													<div class="dropdown">
														 ...
														 <div class="dropdown-content">
																	<a href="#">
																			<img src="/thaink/assets/images/logo/thai.png" width="22" height="15">
																			Thai
																	</a>
																	<a href="#">
																			<img src="/thaink/assets/images/logo/thai.png" width="22" height="15">
...
2. NC Cargo จะเก็บรวบรวมข้อมูลส่วนบุคคลเมื่อใด
							...
							<div class="row w-100">
									...
									<div class="col-xl-6 col-lg-6 px-0">
											 <ul class="navbar-nav navbar-p-l">
													   ...
													   <li class="nav-item">
													      <a class="nav-link navbar-b-r pl-3 pr-3" href="#" data-toggle="modal" data-target="#exampleModal">วิธีการสั่งซื้อ</a>
													   </li>
														 <li class="nav-item">
