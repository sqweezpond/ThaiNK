        	...
        	<div class="row">
                ...
                <div class="col-xl-5 col-lg-4 col-md-7 col-12 footer-bg3 footer-p-t2  footer-p-r footer-padding">
                  <div class="input-group">
                      <input type="email" class="form-control footer-form" placeholder="กรุณาใส่อีเมล" aria-label="Recipient's username" aria-describedby="basic-addon2">
  ...
  <div class="footer-bg3">
      <div class="container">
          <div class="col-12 text-center p-4">
                <span class="footer-font">© 2018 Thai NK. Plastic All rights reserved. Develop by</span>
                <a href="https://www.workbythai.com/" class="footer-link-c">
                  <span><u>Workbythai</u></span>
                </a>
          </div>
      </div>
  </div>
